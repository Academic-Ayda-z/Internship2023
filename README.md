...
made the source code of [link](https://towardsdatascience.com/detecting-heart-arrhythmias-with-deep-learning-in-keras-with-dense-cnn-and-lstm-add337d9e41f) run without any error.(wich used [wfdb]([url](https://physionet.org/content/wfdb-python/4.1.0/)))
